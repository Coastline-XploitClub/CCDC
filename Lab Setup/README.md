...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-disk-selection.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-set-password.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-hardware-override.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-confirm-install.png)

- The installation should complete relatively quickly and you will be prompted to reboot. Press `Enter` to reboot.
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-post-install-reboot.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-first-boot.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-system-menu-auth.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-config-mgmt-network-1.png)

- Next, select `IPv4 Configuration` and press `Enter` to continue.
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-config-mgmt-network-2.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-config-mgmt-network-3.png)

- Next, select `DNS Configuration` and press `Enter` to continue.
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-config-mgmt-network-4.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-config-mgmt-network-5.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-config-mgmt-network-ipv6.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-config-mgmt-network-reboot.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-config-mgmt-network-confirm.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-node-2.png)
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-node-3.png)
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi-node-4.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-iso.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi1-login-1.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi1-login-2.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi1-login-3.png)

- Next, select `Create new VMFS Datastore` and click `Next` to continue.
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi1-storage-1.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi1-storage-2.png)

- Select `VMFS-6` as the file system type and click `Next` to continue.
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi1-storage-3.png)

- Review the summary and click `Finish` to create the datastore.
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi1-storage-4.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-3.png)

- Next, you will be prompted to accept the host's SSL certificate. Click `Yes` to continue.
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-4.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-5.png)

- Next, you will be prompted to select the deployment size. Select `Tiny` and click `Next` to continue.
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-6.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-7.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-8.png)

- Confirm the installation summary and click `Finish` to begin the installation.
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-9.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-10.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-11.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-12.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-13.png)

- Finally, confirm the installation summary and click `Finish` to begin the installation.
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-14.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/esxi1-vcenter-vm.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-installer-15.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/esxi/vcenter-login-1.png)
...
![Alt text](/CCDC/Lab%20Setup/png/proxmox/proxmox-boot.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/proxmox/proxmox-language.png)
Select your language and time zone and press `Enter` to continue.
\
![Alt text](/CCDC/Lab%20Setup/png/proxmox/proxmox-password.png)
Configure a password for the root user and press and an email address for notifications. Press `Enter` to continue.
\
![Alt text](/CCDC/Lab%20Setup/png/proxmox/proxmox-network.png)
...
\
![Alt text](/CCDC/Lab%20Setup/png/proxmox/proxmox-confirm-install.png)
Review the installation summary and press `Enter` to continue.
\
![Alt text](/CCDC/Lab%20Setup/png/proxmox/proxmox-install-reboot.png)
Once the installation is complete, you will be prompted to reboot. Press `Enter` to reboot.
\
![Alt text](/CCDC/Lab%20Setup/png/proxmox/proxmox-first-boot.png)
